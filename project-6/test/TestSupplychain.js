...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 1, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 2, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], 3, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], 4, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 5, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[5], 6, "Invalid itemState");
    })    
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert(resultBufferOne[2], ownerID, "Invalid ownerID");
        assert.equal(resultBufferOne[3], originFarmerID, "Invalid originFarmerID");
        assert.equal(resultBufferOne[4], originFarmName, "Invalid originFarmerName");
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert(resultBufferTwo[4], "Invalid productPrice");
        assert(resultBufferTwo[5], "Invalid itemState");
        assert.equal(resultBufferTwo[6], distributorID, "Invalid distributorID");
        assert.equal(resultBufferTwo[7], retailerID, "Invalid retailereID");
        assert.equal(resultBufferTwo[8], consumerID, "Invalid consumerID"); 
    })
